...
@Repository
public class UserJsonRepository extends JsonRepository<UserEntity> implements UserRepository{
    private static final Path USER_JSON_PATH = Paths.get("src/main/resources/data/users.json");
    private final Map<Long, UserEntity> userDatabase = new ConcurrentHashMap<>();
    private long userId;
