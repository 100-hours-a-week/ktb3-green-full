...
public class UserController {
    ...
    public ResponseEntity<DataResponseDto<CreateUserDto>> updateUserProfile(@RequestBody UpdateUserProfileDto updateUserProfileDto, @AuthUser AuthUserDto authUserDto) {
        CreateUserDto updatedUser = userService.updateUserProfile(authUserDto.getUserId(), updateUserProfileDto);
        return ResponseEntity.status(HttpStatus.OK)
    ...
    public ResponseEntity<Void> updateUserPw(@RequestBody UpdateUserPwDto updateUserPwDto, @AuthUser AuthUserDto authUserDto) {
